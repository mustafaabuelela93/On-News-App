        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                for (int i1 = 0; i1 < tags.length(); i1++) {
                    JSONObject currentAuthor = tags.getJSONObject(i1);
                    if (currentAuthor.isNull("webTitle")) {
                        author = "No authors found";
                    }
                    if (currentAuthor.has("id")) {
                ...
                News newsObject = new News(sectionId, webTitle, url, date, author, thumbnail);
